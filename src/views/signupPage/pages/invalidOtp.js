...
function InvalidOtp({ closeModal }) {
  ...
  return (
    <div ref={modalRef} onClick={bgModal}
      ...
      data-aos="zoom-in"
    >
      <div className="flex flex-col items-center gap-5 sm:gap-10 bg-gradient-to-r from-[#34104A] to-[#250939] p-10 rounded-3xl z-[1000]">
        ...
        <p className="text-center text-[14px] sm:text-[18px]">Invalid OTPs. Please try again.</p>
      </div>
    </div>
  );
}
