  ...
  return (
    <div className=" w-full flex items-center justify-between p-2 lg:p-5 px-5 md:px-14 xl:px-28 fixed bg-gradient-to-b from-[#150c1b] to-[#49474728] bg-opacity-15 z-[100]">
      ...
      <div className="flex gap-5 md:gap-10 items-center">
        ...
        <img src={adam} className="w-9 sm:w-12"></img>
        <a className=" max-sm:text-[12px] p-2 px-3 sm:px-8 rounded-2xl bg-gradient-to-r from-[#4F0F81] to-[#A702FA] cursor-pointer" onClick={handleWalletClick}>
          ADX Wallet
        </a>
