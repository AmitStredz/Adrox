      ...
      <div className="flex justify-evenly items-center p-14 h-72 mt-20 bg-slate-500 bg-opacity-10 rounded-3xl border border-slate-600">
        <div className="flex flex-col gap-10">
          ...
          <div className="flex gap-5 z-50">
            ...
            >
              <img src={deposit} className="w-5" alt="Deposit"></img>
              <p>Deposit</p>
            </div>
            <div
            ...
            >
              <img src={withdraw} className="w-5" alt="Withdraw"></img>
              <p>Withdraw</p>
            </div>
          </div>
        </div>
        <div className="flex flex-col justify-center items-end h-full">
          <div className="flex gap-10">
            <div
              className="flex gap-2 p-2 px-12 items-center rounded-2xl bg-gradient-to-r from-[#4F0F81] to-[#A702FA] cursor-pointer"
