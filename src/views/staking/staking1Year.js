...
//           <div>
//             <h1 className="text-[48px] font-700">Stake USD</h1>
...
//             <div className="flex justify-between">
//               <p>Stake Date</p>
//               <p>2024-05-31 21:30</p>
//             </div>
//             <div className="flex justify-between">
//               <p>Reward Collection</p>
//               <p>2024-06-31 21:30</p>
//             </div>
//           </div>
...
//       const response = await axios.post("https://adrox-0ad3c3933d0d.herokuapp.com/api/staking/create-stake/", data, { // Ensure trailing slash
//         headers: {
//           'Content-Type': 'application/json'
//         }
//       });
